  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative">
      ...
      <div className="relative z-10 w-full px-6 flex flex-col items-center pt-20">
        ...
        <div className="mt-10 lg:mt-12 w-full max-w-[700px]">
          <form onSubmit={handleSearch} className="bg-[#F6F7F9]/94 backdrop-blur-sm rounded-[28px] card-shadow border border-[#0B0F17]/8 overflow-visible">
            <div className="flex flex-col md:flex-row items-stretch">
              {/* Location Dropdown */}
              <div className="flex-1 px-6 py-4 md:py-5 flex items-center gap-4 border-b md:border-b-0 md:border-r border-[#0B0F17]/10">
                ...
                <div className="flex-1">
                  ...
                  <div className="relative">
                    ...
                    {/* Dropdown - positioned outside the search card */}
                    {showLocationDropdown && (
                      <>
                        ...
                        />
                        <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-xl shadow-xl border border-[#0B0F17]/10 max-h-72 overflow-y-auto z-50 min-w-[250px]">
                          <button
                            type="button"
                            onClick={() => { setSelectedLocation(''); setShowLocationDropdown(false); }}
                            className="w-full px-4 py-3 text-left hover:bg-[#F6F7F9] text-[#6B7280] border-b border-[#0B0F17]/5"
                          >
                            All Locations
                          </button>
                          {locations.map((loc) => (
                            <button
                              ...
                              className="w-full px-4 py-3 text-left hover:bg-[#F6F7F9] text-[#0B0F17] flex items-center gap-2 border-b border-[#0B0F17]/5 last:border-0"
                            >
              ...
              {/* Search Input */}
              <div className="flex-1 px-6 py-4 md:py-5 flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <input 
                    ...
                    className="w-full bg-transparent text-[#0B0F17] placeholder:text-[#6B7280] text-base outline-none py-1"
                  />
                </div>
              </div>
